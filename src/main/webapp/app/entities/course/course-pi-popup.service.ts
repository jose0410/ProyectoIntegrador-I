...
@Injectable()
export class CoursePiPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.courseModalRef(component, new CoursePi());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    courseModalRef(component: Component, course: CoursePi): NgbModalRef {
