...
@Injectable()
export class ProfessorPiPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.professorModalRef(component, new ProfessorPi());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    professorModalRef(component: Component, professor: ProfessorPi): NgbModalRef {
